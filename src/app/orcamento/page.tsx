...
export const metadata = pageMetadata("Solicitar orçamento", "Monte e revise uma solicitação de orçamento B2B para diagnóstico e rotinas laboratoriais.", "/orcamento");
